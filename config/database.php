    ...
    */
    ...
    'connections' => [
        ...
        'ami' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_AMI', 'localhost'),
            'port' => env('DB_PORT_AMI', '1433'),
            'database' => env('DB_DATABASE_AMI', 'forge'),
            'username' => env('DB_USERNAME_AMI', 'forge'),
            'password' => env('DB_PASSWORD_AMI', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
        ],
        ...
        'cms' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_CMS', 'localhost'),
            'port' => env('DB_PORT_CMS', '1433'),
